...
/**
 * LArtistReleaseGroup generated by hbm2java
 */
public class LArtistReleaseGroup implements java.io.Serializable {
	...
	public LArtistReleaseGroup() {
	}

	public LArtistReleaseGroup(int id, int link, int entity0, int entity1,

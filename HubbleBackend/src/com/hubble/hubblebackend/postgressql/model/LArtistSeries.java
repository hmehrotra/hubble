...
/**
 * LArtistSeries generated by hbm2java
 */
public class LArtistSeries implements java.io.Serializable {
	...
	public LArtistSeries() {
	}

	public LArtistSeries(int id, int link, int entity0, int entity1,

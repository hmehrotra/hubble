...
/**
 * LInstrumentReleaseGroup generated by hbm2java
 */
public class LInstrumentReleaseGroup implements java.io.Serializable {
	...
	public LInstrumentReleaseGroup() {
	}

	public LInstrumentReleaseGroup(int id, int link, int entity0, int entity1,

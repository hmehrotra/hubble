...
/**
 * LReleaseRelease generated by hbm2java
 */
public class LReleaseRelease implements java.io.Serializable {
	...
	public LReleaseRelease() {
	}

	public LReleaseRelease(int id, int link, int entity0, int entity1,

 ...
 * @see com.hubble.hubblebackend.postgressql.model.Gender
 * @author Hibernate Tools
 */
public class GenderHome {
	...
	public Gender merge(Gender detachedInstance) {
		...
		try {
			Gender result = (Gender) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Gender findById(int id) {
		...
		try {
			Gender instance = (Gender) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Gender", id);
			if (instance == null) {
	...
	public List findByExample(Gender instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Gender")

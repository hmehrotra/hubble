 ...
 * @see com.hubble.hubblebackend.postgressql.model.Track
...
public class TrackHome {
	...
	public Track merge(Track detachedInstance) {
		...
		try {
			Track result = (Track) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Track findById(int id) {
		...
		try {
			Track instance = (Track) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Track", id);
			if (instance == null) {
	...
	public List findByExample(Track instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Track")

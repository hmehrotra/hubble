 ...
 * @see com.hubble.hubblebackend.postgressql.model.Event
	...
	public Event findById(int id) {
		...
		try {
			Event instance = (Event) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Event", id);
			if (instance == null) {
	...
	public List findByExample(Event instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Event")

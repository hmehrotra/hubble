 ...
 * @see com.hubble.hubblebackend.postgressql.model.Instrument
	...
	public Instrument findById(int id) {
		...
		try {
			Instrument instance = (Instrument) sessionFactory
					.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.Instrument",
							id);
			if (instance == null) {
	...
	public List findByExample(Instrument instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Instrument")

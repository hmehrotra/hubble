...
/**
 * AreaAlias generated by hbm2java
 */
public class AreaAlias implements java.io.Serializable {
	...
	public AreaAlias(int id, int area, String name, int editsPending,
	...
	public AreaAlias(int id, int area, String name, String locale,

...
public class Label implements java.io.Serializable {
	...
	public Label(int id, Serializable gid, String name, String comment,
			int editsPending, boolean ended) {
		this.id = id;
		this.gid = gid;
		this.name = name;
	...
	public Label(int id, Serializable gid, String name, Short beginDateYear,
			Short beginDateMonth, Short beginDateDay, Short endDateYear,
			Short endDateMonth, Short endDateDay, Integer labelCode,
			Integer type, Integer area, String comment, int editsPending,
			Date lastUpdated, boolean ended) {
		this.id = id;
		this.gid = gid;
		this.name = name;

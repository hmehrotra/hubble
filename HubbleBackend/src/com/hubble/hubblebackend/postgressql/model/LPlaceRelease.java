...
/**
 * LPlaceRelease generated by hbm2java
 */
public class LPlaceRelease implements java.io.Serializable {
	...
	public LPlaceRelease() {
	}

	public LPlaceRelease(int id, int link, int entity0, int entity1,

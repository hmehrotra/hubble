...
/**
 * LReleaseGroupUrl generated by hbm2java
 */
public class LReleaseGroupUrl implements java.io.Serializable {
	...
	public LReleaseGroupUrl() {
	}

	public LReleaseGroupUrl(int id, int link, int entity0, int entity1,

...
/**
 * LAreaRecording generated by hbm2java
 */
public class LAreaRecording implements java.io.Serializable {
	...
	public LAreaRecording() {
	}

	public LAreaRecording(int id, int link, int entity0, int entity1,

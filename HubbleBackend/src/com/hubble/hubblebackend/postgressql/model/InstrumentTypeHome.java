 ...
 * @see com.hubble.hubblebackend.postgressql.model.InstrumentType
...
public class InstrumentTypeHome {
	...
	public InstrumentType findById(int id) {
		...
		try {
			InstrumentType instance = (InstrumentType) sessionFactory
					.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.InstrumentType",
							id);
			if (instance == null) {
	...
	public List findByExample(InstrumentType instance) {
		log.debug("finding InstrumentType instance by example");
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.InstrumentType")

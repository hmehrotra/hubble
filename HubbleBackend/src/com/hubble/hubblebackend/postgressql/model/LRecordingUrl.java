...
/**
 * LRecordingUrl generated by hbm2java
 */
public class LRecordingUrl implements java.io.Serializable {
	...
	public LRecordingUrl() {
	}

	public LRecordingUrl(int id, int link, int entity0, int entity1,

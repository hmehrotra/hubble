...
/**
 * Home object for domain model class Work.
 * @see com.hubble.hubblebackend.postgressql.model.Work
 * @author Hibernate Tools
 */
public class WorkHome {

	private static final Log log = LogFactory.getLog(WorkHome.class);
	...
	public void persist(Work transientInstance) {
		log.debug("persisting Work instance");
		try {
	...
	public Work merge(Work detachedInstance) {
		...
		try {
			Work result = (Work) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Work findById(int id) {
		...
		try {
			Work instance = (Work) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Work", id);
			if (instance == null) {
	...
	public List findByExample(Work instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Work")

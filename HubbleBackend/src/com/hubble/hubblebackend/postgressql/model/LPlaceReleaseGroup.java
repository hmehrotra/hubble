...
/**
 * LPlaceReleaseGroup generated by hbm2java
 */
public class LPlaceReleaseGroup implements java.io.Serializable {
	...
	public LPlaceReleaseGroup() {
	}

	public LPlaceReleaseGroup(int id, int link, int entity0, int entity1,

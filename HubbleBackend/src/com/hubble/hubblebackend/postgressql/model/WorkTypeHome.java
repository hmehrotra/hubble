...
/**
 * Home object for domain model class WorkType.
 * @see com.hubble.hubblebackend.postgressql.model.WorkType
 * @author Hibernate Tools
 */
public class WorkTypeHome {

	private static final Log log = LogFactory.getLog(WorkTypeHome.class);
	...
	public void persist(WorkType transientInstance) {
		log.debug("persisting WorkType instance");
		try {
	...
	public WorkType merge(WorkType detachedInstance) {
		...
		try {
			WorkType result = (WorkType) sessionFactory.getCurrentSession()
	...
	public WorkType findById(int id) {
		...
		try {
			WorkType instance = (WorkType) sessionFactory.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.WorkType",
							id);
			if (instance == null) {
	...
	public List findByExample(WorkType instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.WorkType")

...
/**
 * LLabelReleaseGroup generated by hbm2java
 */
public class LLabelReleaseGroup implements java.io.Serializable {
	...
	public LLabelReleaseGroup() {
	}

	public LLabelReleaseGroup(int id, int link, int entity0, int entity1,

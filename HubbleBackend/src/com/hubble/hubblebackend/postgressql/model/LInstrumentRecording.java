...
/**
 * LInstrumentRecording generated by hbm2java
 */
public class LInstrumentRecording implements java.io.Serializable {
	...
	public LInstrumentRecording() {
	}

	public LInstrumentRecording(int id, int link, int entity0, int entity1,

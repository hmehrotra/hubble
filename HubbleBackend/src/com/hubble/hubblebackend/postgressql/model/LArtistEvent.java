...
/**
 * LArtistEvent generated by hbm2java
 */
public class LArtistEvent implements java.io.Serializable {
	...
	public LArtistEvent(int id, int link, int entity0, int entity1,

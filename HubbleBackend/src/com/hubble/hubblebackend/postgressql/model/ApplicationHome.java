 ...
 * @see com.hubble.hubblebackend.postgressql.model.Application
...
public class ApplicationHome {
	...
	public Application merge(Application detachedInstance) {
		...
		try {
			Application result = (Application) sessionFactory
	...
	public Application findById(int id) {
		...
		try {
			Application instance = (Application) sessionFactory
					.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.Application",
							id);
			if (instance == null) {
	...
	public List findByExample(Application instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Application")

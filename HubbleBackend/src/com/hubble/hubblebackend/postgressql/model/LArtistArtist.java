...
/**
 * LArtistArtist generated by hbm2java
 */
public class LArtistArtist implements java.io.Serializable {
	...
	public LArtistArtist() {
	}

	public LArtistArtist(int id, int link, int entity0, int entity1,

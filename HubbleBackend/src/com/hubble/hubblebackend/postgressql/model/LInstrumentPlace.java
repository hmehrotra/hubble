...
/**
 * LInstrumentPlace generated by hbm2java
 */
public class LInstrumentPlace implements java.io.Serializable {
	...
	public LInstrumentPlace() {
	}

	public LInstrumentPlace(int id, int link, int entity0, int entity1,

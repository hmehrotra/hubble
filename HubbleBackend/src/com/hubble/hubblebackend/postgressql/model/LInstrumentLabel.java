...
/**
 * LInstrumentLabel generated by hbm2java
 */
public class LInstrumentLabel implements java.io.Serializable {
	...
	public LInstrumentLabel() {
	}

	public LInstrumentLabel(int id, int link, int entity0, int entity1,

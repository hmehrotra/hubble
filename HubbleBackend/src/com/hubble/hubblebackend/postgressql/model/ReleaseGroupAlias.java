...
/**
 * ReleaseGroupAlias generated by hbm2java
 */
public class ReleaseGroupAlias implements java.io.Serializable {
	...
	public ReleaseGroupAlias() {
	}

	public ReleaseGroupAlias(int id, int releaseGroup, String name,
			int editsPending, String sortName, boolean primaryForLocale,
			boolean ended) {
		this.id = id;
	...
	public ReleaseGroupAlias(int id, int releaseGroup, String name,
			String locale, int editsPending, Date lastUpdated, Integer type,
			String sortName, Short beginDateYear, Short beginDateMonth,
			Short beginDateDay, Short endDateYear, Short endDateMonth,
			Short endDateDay, boolean primaryForLocale, boolean ended) {
		this.id = id;
		this.releaseGroup = releaseGroup;
		this.name = name;
		this.locale = locale;

...
/**
 * LRecordingRecording generated by hbm2java
 */
public class LRecordingRecording implements java.io.Serializable {
	...
	public LRecordingRecording() {
	}

	public LRecordingRecording(int id, int link, int entity0, int entity1,

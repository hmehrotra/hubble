...
/**
 * LReleaseSeries generated by hbm2java
 */
public class LReleaseSeries implements java.io.Serializable {
	...
	public LReleaseSeries() {
	}

	public LReleaseSeries(int id, int link, int entity0, int entity1,

...
/**
 * LEventInstrument generated by hbm2java
 */
public class LEventInstrument implements java.io.Serializable {
	...
	public LEventInstrument() {
	}

	public LEventInstrument(int id, int link, int entity0, int entity1,

 ...
 * @see com.hubble.hubblebackend.postgressql.model.Language
	...
	public Language findById(int id) {
		...
		try {
			Language instance = (Language) sessionFactory.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.Language",
							id);
			if (instance == null) {
	...
	public List findByExample(Language instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Language")

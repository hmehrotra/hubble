...
/**
 * LPlaceRecording generated by hbm2java
 */
public class LPlaceRecording implements java.io.Serializable {
	...
	public LPlaceRecording() {
	}

	public LPlaceRecording(int id, int link, int entity0, int entity1,

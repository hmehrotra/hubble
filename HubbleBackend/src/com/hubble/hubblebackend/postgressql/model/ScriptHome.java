...
/**
 * Home object for domain model class Script.
 * @see com.hubble.hubblebackend.postgressql.model.Script
 * @author Hibernate Tools
 */
public class ScriptHome {

	private static final Log log = LogFactory.getLog(ScriptHome.class);
	...
	public void persist(Script transientInstance) {
		log.debug("persisting Script instance");
		try {
	...
	public Script merge(Script detachedInstance) {
		...
		try {
			Script result = (Script) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Script findById(int id) {
		...
		try {
			Script instance = (Script) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Script", id);
			if (instance == null) {
	...
	public List findByExample(Script instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Script")

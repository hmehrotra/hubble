...
/**
 * LArtistRelease generated by hbm2java
 */
public class LArtistRelease implements java.io.Serializable {
	...
	public LArtistRelease() {
	}

	public LArtistRelease(int id, int link, int entity0, int entity1,

...
/**
 * LReleaseGroupWork generated by hbm2java
 */
public class LReleaseGroupWork implements java.io.Serializable {
	...
	public LReleaseGroupWork() {
	}

	public LReleaseGroupWork(int id, int link, int entity0, int entity1,

...
/**
 * LRecordingSeries generated by hbm2java
 */
public class LRecordingSeries implements java.io.Serializable {
	...
	public LRecordingSeries() {
	}

	public LRecordingSeries(int id, int link, int entity0, int entity1,

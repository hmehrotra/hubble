...
/**
 * LabelAlias generated by hbm2java
 */
public class LabelAlias implements java.io.Serializable {
	...
	public LabelAlias(int id, int label, String name, int editsPending,
	...
	public LabelAlias(int id, int label, String name, String locale,

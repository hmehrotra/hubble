...
/**
 * LRecordingRelease generated by hbm2java
 */
public class LRecordingRelease implements java.io.Serializable {
	...
	public LRecordingRelease() {
	}

	public LRecordingRelease(int id, int link, int entity0, int entity1,

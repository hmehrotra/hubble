...
/**
 * LReleaseReleaseGroup generated by hbm2java
 */
public class LReleaseReleaseGroup implements java.io.Serializable {
	...
	public LReleaseReleaseGroup() {
	}

	public LReleaseReleaseGroup(int id, int link, int entity0, int entity1,

 ...
 * @see com.hubble.hubblebackend.postgressql.model.EventType
...
public class EventTypeHome {
	...
	public EventType findById(int id) {
		...
		try {
			EventType instance = (EventType) sessionFactory
					.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.EventType",
							id);
			if (instance == null) {
	...
	public List findByExample(EventType instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.EventType")

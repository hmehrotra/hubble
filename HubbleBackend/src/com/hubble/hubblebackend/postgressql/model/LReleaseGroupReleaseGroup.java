...
/**
 * LReleaseGroupReleaseGroup generated by hbm2java
 */
public class LReleaseGroupReleaseGroup implements java.io.Serializable {
	...
	public LReleaseGroupReleaseGroup() {
	}

	public LReleaseGroupReleaseGroup(int id, int link, int entity0,
			int entity1, int editsPending, int linkOrder, String entity0Credit,
	...
	public LReleaseGroupReleaseGroup(int id, int link, int entity0,
			int entity1, int editsPending, Date lastUpdated, int linkOrder,

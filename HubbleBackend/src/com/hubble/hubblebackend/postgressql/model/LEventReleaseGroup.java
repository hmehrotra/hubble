...
/**
 * LEventReleaseGroup generated by hbm2java
 */
public class LEventReleaseGroup implements java.io.Serializable {
	...
	public LEventReleaseGroup() {
	}

	public LEventReleaseGroup(int id, int link, int entity0, int entity1,

...
/**
 * LRecordingWork generated by hbm2java
 */
public class LRecordingWork implements java.io.Serializable {
	...
	public LRecordingWork() {
	}

	public LRecordingWork(int id, int link, int entity0, int entity1,

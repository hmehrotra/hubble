...
/**
 * LAreaReleaseGroup generated by hbm2java
 */
public class LAreaReleaseGroup implements java.io.Serializable {
	...
	public LAreaReleaseGroup() {
	}

	public LAreaReleaseGroup(int id, int link, int entity0, int entity1,

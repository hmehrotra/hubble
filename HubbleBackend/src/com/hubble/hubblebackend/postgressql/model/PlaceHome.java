 ...
 * @see com.hubble.hubblebackend.postgressql.model.Place
...
public class PlaceHome {
	...
	public Place merge(Place detachedInstance) {
		...
		try {
			Place result = (Place) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Place findById(int id) {
		...
		try {
			Place instance = (Place) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Place", id);
			if (instance == null) {
	...
	public List findByExample(Place instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Place")

 ...
 * @see com.hubble.hubblebackend.postgressql.model.Series
...
public class SeriesHome {
	...
	public Series merge(Series detachedInstance) {
		...
		try {
			Series result = (Series) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Series findById(int id) {
		...
		try {
			Series instance = (Series) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Series", id);
			if (instance == null) {
	...
	public List findByExample(Series instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Series")

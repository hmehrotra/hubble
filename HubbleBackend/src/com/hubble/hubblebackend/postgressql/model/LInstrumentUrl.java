...
/**
 * LInstrumentUrl generated by hbm2java
 */
public class LInstrumentUrl implements java.io.Serializable {
	...
	public LInstrumentUrl() {
	}

	public LInstrumentUrl(int id, int link, int entity0, int entity1,

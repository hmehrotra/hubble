...
/**
 * LEventRelease generated by hbm2java
 */
public class LEventRelease implements java.io.Serializable {
	...
	public LEventRelease() {
	}

	public LEventRelease(int id, int link, int entity0, int entity1,

...
/**
 * LRecordingReleaseGroup generated by hbm2java
 */
public class LRecordingReleaseGroup implements java.io.Serializable {
	...
	public LRecordingReleaseGroup() {
	}

	public LRecordingReleaseGroup(int id, int link, int entity0, int entity1,

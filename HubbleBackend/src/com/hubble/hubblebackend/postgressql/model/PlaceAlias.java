...
/**
 * PlaceAlias generated by hbm2java
 */
public class PlaceAlias implements java.io.Serializable {
	...
	public PlaceAlias(int id, int place, String name, int editsPending,
	...
	public PlaceAlias(int id, int place, String name, String locale,

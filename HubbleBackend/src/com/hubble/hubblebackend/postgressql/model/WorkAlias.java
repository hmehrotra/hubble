...
/**
 * WorkAlias generated by hbm2java
 */
public class WorkAlias implements java.io.Serializable {
	...
	public WorkAlias(int id, int work, String name, int editsPending,
	...
	public WorkAlias(int id, int work, String name, String locale,

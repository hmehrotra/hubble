...
/**
 * LLabelRelease generated by hbm2java
 */
public class LLabelRelease implements java.io.Serializable {
	...
	public LLabelRelease() {
	}

	public LLabelRelease(int id, int link, int entity0, int entity1,

 ...
 * @see com.hubble.hubblebackend.postgressql.model.Artist
...
public class ArtistHome {
	...
	public Artist merge(Artist detachedInstance) {
		...
		try {
			Artist result = (Artist) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Artist findById(int id) {
		...
		try {
			Artist instance = (Artist) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Artist", id);
			if (instance == null) {
	...
	public List findByExample(Artist instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Artist")

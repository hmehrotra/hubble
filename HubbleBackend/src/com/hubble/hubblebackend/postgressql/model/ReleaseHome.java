 ...
 * @see com.hubble.hubblebackend.postgressql.model.Release
 * @author Hibernate Tools
 */
public class ReleaseHome {

	private static final Log log = LogFactory.getLog(ReleaseHome.class);
	...
	public Release findById(int id) {
		log.debug("getting Release instance with id: " + id);
		try {
			Release instance = (Release) sessionFactory.getCurrentSession()
					.get("com.hubble.hubblebackend.postgressql.model.Release",
							id);
			if (instance == null) {
	...
	public List findByExample(Release instance) {
		log.debug("finding Release instance by example");
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Release")

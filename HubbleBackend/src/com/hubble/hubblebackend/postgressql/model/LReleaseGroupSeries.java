...
/**
 * LReleaseGroupSeries generated by hbm2java
 */
public class LReleaseGroupSeries implements java.io.Serializable {
	...
	public LReleaseGroupSeries() {
	}

	public LReleaseGroupSeries(int id, int link, int entity0, int entity1,

...
/**
 * LArtistRecording generated by hbm2java
 */
public class LArtistRecording implements java.io.Serializable {
	...
	public LArtistRecording() {
	}

	public LArtistRecording(int id, int link, int entity0, int entity1,

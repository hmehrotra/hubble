...
/**
 * LSeriesSeries generated by hbm2java
 */
public class LSeriesSeries implements java.io.Serializable {
	...
	public LSeriesSeries() {
	}

	public LSeriesSeries(int id, int link, int entity0, int entity1,

...
/**
 * LLabelRecording generated by hbm2java
 */
public class LLabelRecording implements java.io.Serializable {
	...
	public LLabelRecording() {
	}

	public LLabelRecording(int id, int link, int entity0, int entity1,

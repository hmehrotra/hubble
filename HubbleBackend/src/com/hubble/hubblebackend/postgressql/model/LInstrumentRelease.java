...
/**
 * LInstrumentRelease generated by hbm2java
 */
public class LInstrumentRelease implements java.io.Serializable {
	...
	public LInstrumentRelease() {
	}

	public LInstrumentRelease(int id, int link, int entity0, int entity1,

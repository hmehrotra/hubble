...
/**
 * LAreaInstrument generated by hbm2java
 */
public class LAreaInstrument implements java.io.Serializable {
	...
	public LAreaInstrument() {
	}

	public LAreaInstrument(int id, int link, int entity0, int entity1,

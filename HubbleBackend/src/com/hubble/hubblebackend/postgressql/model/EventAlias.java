...
/**
 * EventAlias generated by hbm2java
 */
public class EventAlias implements java.io.Serializable {
	...
	public EventAlias(int id, int event, String name, int editsPending,
	...
	public EventAlias(int id, int event, String name, String locale,

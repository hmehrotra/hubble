...
/**
 * LInstrumentWork generated by hbm2java
 */
public class LInstrumentWork implements java.io.Serializable {
	...
	public LInstrumentWork() {
	}

	public LInstrumentWork(int id, int link, int entity0, int entity1,

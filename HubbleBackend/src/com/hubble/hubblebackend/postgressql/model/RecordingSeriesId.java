...
/**
 * RecordingSeriesId generated by hbm2java
 */
public class RecordingSeriesId implements java.io.Serializable {
	...
	public RecordingSeriesId() {
	}

	public RecordingSeriesId(Integer recording, Integer series,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecordingSeriesId))
			return false;
		RecordingSeriesId castOther = (RecordingSeriesId) other;

		return ((this.getRecording() == castOther.getRecording()) || (this
				.getRecording() != null && castOther.getRecording() != null && this
				.getRecording().equals(castOther.getRecording())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getRecording() == null ? 0 : this.getRecording().hashCode());
		result = 37 * result

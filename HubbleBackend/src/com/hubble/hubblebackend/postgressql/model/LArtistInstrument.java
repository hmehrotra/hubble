...
/**
 * LArtistInstrument generated by hbm2java
 */
public class LArtistInstrument implements java.io.Serializable {
	...
	public LArtistInstrument() {
	}

	public LArtistInstrument(int id, int link, int entity0, int entity1,

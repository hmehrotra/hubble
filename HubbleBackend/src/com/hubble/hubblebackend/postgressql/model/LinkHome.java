 ...
 * @see com.hubble.hubblebackend.postgressql.model.Link
...
public class LinkHome {
	...
	public Link merge(Link detachedInstance) {
		...
		try {
			Link result = (Link) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Link findById(int id) {
		...
		try {
			Link instance = (Link) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Link", id);
			if (instance == null) {
	...
	public List findByExample(Link instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Link")

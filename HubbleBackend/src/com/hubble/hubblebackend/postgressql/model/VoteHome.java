 ...
 * @see com.hubble.hubblebackend.postgressql.model.Vote
 * @author Hibernate Tools
 */
public class VoteHome {

	private static final Log log = LogFactory.getLog(VoteHome.class);
	...
	public Vote merge(Vote detachedInstance) {
		...
		try {
			Vote result = (Vote) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Vote findById(int id) {
		...
		try {
			Vote instance = (Vote) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Vote", id);
			if (instance == null) {
	...
	public List findByExample(Vote instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Vote")

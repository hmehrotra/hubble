...
/**
 * LInstrumentSeries generated by hbm2java
 */
public class LInstrumentSeries implements java.io.Serializable {
	...
	public LInstrumentSeries() {
	}

	public LInstrumentSeries(int id, int link, int entity0, int entity1,

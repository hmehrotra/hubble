 ...
 * @see com.hubble.hubblebackend.postgressql.model.Label
...
public class LabelHome {
	...
	public Label merge(Label detachedInstance) {
		...
		try {
			Label result = (Label) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Label findById(int id) {
		...
		try {
			Label instance = (Label) sessionFactory.getCurrentSession().get(
					"com.hubble.hubblebackend.postgressql.model.Label", id);
			if (instance == null) {
	...
	public List findByExample(Label instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.hubble.hubblebackend.postgressql.model.Label")

...
/**
 * LInstrumentInstrument generated by hbm2java
 */
public class LInstrumentInstrument implements java.io.Serializable {
	...
	public LInstrumentInstrument() {
	}

	public LInstrumentInstrument(int id, int link, int entity0, int entity1,
